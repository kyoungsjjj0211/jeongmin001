        ...
        >
            ...
            >
                ...
                <Form.Item
                    ...
                    rules={[{ required: true }]}
                >
                    <Input placeholder="레시피의 특징을 한 줄로 소개해주세요." />
                </Form.Item>
                ...
                <Form.Item
                    ...
                    rules={[{ required: true }]}
                >
                    <Input.TextArea rows={3} placeholder="필요한 재료를 입력해주세요." />
                </Form.Item>
                ...
                <Form.Item
                    ...
                    rules={[{ required: true }]}
                >
                    <Input.TextArea rows={6} placeholder="상세한 조리법을 적어주세요." />
                </Form.Item>
                ...
                {/* 7. 이미지 수정 안내 */}
                <Form.Item label="요리 이미지 변경 (새 사진 업로드 시 기존 사진 대체)">
                    <Upload 
                        multiple 
                        beforeUpload={() => false} 
