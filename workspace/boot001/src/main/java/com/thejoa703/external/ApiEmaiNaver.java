...
@Component
public class ApiEmaiNaver {
		public void sendMail(String subject, String content , String email) {
			//1. 보내는쪽
			String host     = "smtp.naver.com";
			String user     = "kyoungsjjj@naver.com";  //네이버아이디@naver.com
			
			String password = "N9FQNVKETH2C";       //2단계인증 비밀번호 
			...
			try {
				message.setFrom(  new  InternetAddress(user)); //보내는사람  kyoungsjjj@naver.com
