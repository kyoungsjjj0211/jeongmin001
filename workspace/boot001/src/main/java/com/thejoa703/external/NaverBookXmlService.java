...
public class NaverBookXmlService {
	...
	@JacksonXmlElementWrapper(useWrapping = false) //items들을 묶어서 wrapper태그 없이 <item></item> <item></item> 
	...
	//Dao 가져오기
		public List<BookDto> getBooks(String query) throws UnsupportedEncodingException{
			...
			String clientId="FigimYBBeWqPMrh2uQ0W"; //clientId
			String clientSecret="g4voC20v0G"; 		//clientSecret
