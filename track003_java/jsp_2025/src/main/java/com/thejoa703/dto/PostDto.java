...
public class PostDto {
	...
	public PostDto(int id, int appUserId, String title, String content, String pass, LocalDateTime createdAt, int hit) {
		super();this.id = id; this.appUserId = appUserId; this.title = title; this.content = content; this.pass = pass; this.createdAt = createdAt; this.hit = hit;}

	@Override public String toString() { return "PostDto [id=" + id + ", appUserId=" + appUserId + ", title=" + title + ", content=" + content
