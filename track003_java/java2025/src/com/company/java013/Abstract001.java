...
abstract class Animal{ //일반클래스 + 설계
 ...
 class Cat extends Animal{  // 구현클래스-고양이는 동물이다 The type Cat must implement the inherited abstract method Animal.sleep()
	...
	class Dog extends Animal{  // 구현클래스-강아지는 동물이다 The type Cat must implement the inherited abstract method Animal.sleep()
...
public class Abstract001 {
	...
	public static void main(String[] args) {
		...
		//Animal ani = new Animal();  //new 메모리빌리고, 객체생성/ Anumal() 초기화, {}구현부없음 // new를 직접 사용할수 없음, 직접 떠먹여줘야함. 너 자 너 먹어 너 누워 등 직접명령이 필요함
