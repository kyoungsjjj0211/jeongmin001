...
export const materialApi = {
  // 1. 목록 조회 (페이징/검색)
  getList: (params) => axios.get('/api/materials', { params }),
  // 2. 상세 조회
  getDetail: (id) => axios.get(`/api/materials/${id}`),
  // 3. 등록 (Multipart)
  create: (formData) => axios.post('/api/materials', formData),
  // 4. 수정 (Multipart)
  update: (id, formData) => axios.put(`/api/materials/${id}`, formData),
  // 5. 삭제
  delete: (id) => axios.delete(`/api/materials/${id}`),
};