...
> 복습문제로 정리
> 실습
- Q1. 금일정리파일 day005.md github에 올리기 
- Q2. github [클라우드]에서 day005.md 수정
- Q3. git [로컬]에서 day005.md 클라우드와 수정한 다른부분 수정후 올리기
- Q4. Q3 발생하는 오류 수정 - 트러블슈팅

1. 발생문제 : 로컬 master 와 원격 (origin/master) 차이 발생
2. 해결방안 : 
...
큰 물통(정수)    고압탱크(압축해서 엄청난 물 담기 - 실수+지수)
