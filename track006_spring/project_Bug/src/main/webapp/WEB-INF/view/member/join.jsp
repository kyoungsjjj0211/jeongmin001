        ...
        $.ajax({
            ...
            success : function(res) {
                if(res.cnt != null){
                    ...
                    $(".iddouble_result").empty().append("<span class='text-danger p-3'>이미 사용중인 이메일 입니다.</span>");
                }else{ 
                    $(".iddouble_result").attr("data-role", "ok");  
                    $(".iddouble_result").empty().append("<span class='text-success p-3'>사용가능한 이메일 입니다.</span>");
                }
            },
            error : function() {
        ...
        $.ajax({
            ...
            success : function(res) {
                if(res.cnt > 0){
                    ...
                    $(".nickdouble_result").empty().append("<span class='text-danger p-3'>이미 사용중인 닉네임 입니다.</span>");
                }else{ 
                    $(".nickdouble_result").attr("data-role", "ok");  
                    $(".nickdouble_result").empty().append("<span class='text-success p-3'>사용가능한 닉네임 입니다.</span>");
                }
            },
            error : function() {
        ...
        $.ajax({
            ...
            success : function(res) {
                if(res.cnt > 0){
                    ...
                    $(".mobiledouble_result").empty().append("<span class='text-danger p-3'>이미 사용중인 휴대폰 번호 입니다.</span>");
                }else{ 
                    $(".mobiledouble_result").attr("data-role", "ok");  
                    $(".mobiledouble_result").empty().append("<span class='text-success p-3'>사용가능한 휴대폰 번호 입니다.</span>");
                }
            },
            error : function() {
