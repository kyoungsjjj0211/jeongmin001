...
<%@include file="../inc/header.jsp" %> 
	...
	$(function(){
		...
		else is(reuslt.length !=0 ){alert(result); } // 아까 처음 값이 없을때 공백
   ...
   <div class="container card  my-5 p-4">
	  ...
	  <div> 
		  ...
		  <div class="mb-3">
		  	<a href="${pageContext.request.contextPath}/list.quest?id=${dto.id}" class="btn btn-primary form-control">목록보기</a>
		  </div>
	 </div>
   </div> 
